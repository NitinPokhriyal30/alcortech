...
const PostCard = () => {
    return (
        <div>
            <div className="bg-white rounded-lg px-8 pt-8 pb-14">
                ...
                <div className="mt-4">
                    <p className="font-Lato font-bold text-lg leading-5">
                    ...
                    <p className="font-Lato font-normal mt-2 text-[#464646] text-lg leading-5">
                        ...
                        <div className="w-full">
                            <div className="flex justify-end items-center relative">
                                <input
                                    ...
                                    className=" bg-[#EDEDED] rounded-b-xl rounded-tr-xl w-full px-6 py-3 placeholder:text-lg placeholder:text-[#ABACAC] placeholder:font-Lato border-none outline-none"
                                />
                    ...
                    <div className="flex items-center mt-3">
                        ...
                        <div className="w-full ">
                            <div className="bg-[#EDEDED] flex items-start justify-between rounded-b-xl rounded-tr-xl w-full px-6 py-3">
                                <div>
                                    <p className="font-Lato font-bold text-lg leading-5 text-[#464646]">Sunita Gulia </p>
                                    <p className="font-Lato font-normal text-lg leading-5 text-[#464646]">Thank You, Semad </p>
                                </div>
                                <div>
