    ...
    return (
        <div>
            <div className="flex items-center gap-2 justify-between">
                ...
                <div className="xxl:w-1/5 xl:w-1/5 lg:w-1/5 md:w-1/5 sm:w-[40%] xs:w-[40%] ">
                    <p className="font-Lato text-[#7B7B7B] text-sm relative flex items-center">
                        ...
                        <div className="hidden drop-shadow-[0px_2px_6px_#44444F1A] px-4 py-2 rounded-lg bg-white absolute top-[21px] right-[1px] peer-hover:flex hover:flex  flex-col text-end">
